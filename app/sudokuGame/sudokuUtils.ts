...
export const sudokuCreator = (): number[] => {
    ...
    if (!solution) return createSimpleBoard();
...
export const shuffleNumber = <T,>(arr: T[]): T[] => {
    const shuffled = [...arr];
...
// Create a simple valid Sudoku board (for fallback)
export const createSimpleBoard = (): number[] => {
    // This is a simple valid Sudoku board with some numbers removed
    return [
        5, 3, 0, 0, 7, 0, 0, 0, 0,
        6, 0, 0, 1, 9, 5, 0, 0, 0,
        0, 9, 8, 0, 0, 0, 0, 6, 0,
