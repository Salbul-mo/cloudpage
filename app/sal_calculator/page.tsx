...
const SalaryCalculator: React.FC = () => {
  ...
  const calculateSalary = useCallback(() => {
    ...
    const requiredOvertimeHours =
      (adjustableGross / hourlyWage - monthlyStandardHours) / 1.5;

    if (requiredOvertimeHours < 0) {
      const minPossibleGross =
        monthlyStandardHours * hourlyWage + nonHourlyBasedPay;
      setError(
      ...
      hourlyWage =
        adjustableGross / (monthlyStandardHours + overtimeHours * 1.5);
    } else {
