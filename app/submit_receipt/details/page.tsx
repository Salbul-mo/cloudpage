...
const ReceiptDetailsForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const suspiciousPatterns = [/<script/i, /javascript:/i, /on\w+\s*=/i, /drop\s+table/i, /delete\s+from/i, /insert\s+into/i, /update\s+set/i];
        const allInputs = [accountTitle, itemDescription, payee || '', projectPurpose || ''].join(' ');
